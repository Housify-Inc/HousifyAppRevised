...
def tenant_handler():
    ...
    if request.method == 'OPTIONS':
        ...
        try:
            house_instance = House(property_address=group, property_owner="", group="", real_estate="")
            ...
            for i in house_instance.group.all_housemates:
                user_instance = User(username=i, password="", payment_info="", user_type="", first_name="", last_name="", phone_number="")
